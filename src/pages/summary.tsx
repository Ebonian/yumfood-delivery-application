...
const Summary: NextPage = () => {
  const { pickup, dropoff, setPickup, setDropoff, setJobIsActive } =
    useContext(JobState);

  const list = [
    "Java Chip Venti Size",
    "Spinach Quiche",
    "Earl Grey Matcha Cake",
  ];
        ...
        <main className="flex flex-col justify-between h-screen font-poppins select-none">
          ...
          <div className="flex flex-col flex-grow bg-gray-100 px-6 pt-12">
            <div className="rounded-xl bg-white w-full pt-5 pb-7 px-6">
              ...
              <ol className="list-decimal font-semibold ml-6 mt-4 mr-3 space-y-4 text-sm">
                {list.map((l, i) => (
                  <li key={i}>
          ...
          <div className="p-6 bg-gray-100">
            <Link href="/dropoff">
              <a
                className="grid place-content-center uppercase text-white font-medium rounded-full bg-primary py-[14px] px-12"
                onClick={() => {
                  setPickup(false);
                  setDropoff(true);
                }}
